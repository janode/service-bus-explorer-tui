...
[src/event.rs](../../../src/event.rs) routes keys in this exact order:
...
| 3 | (varies) | If the key triggers an async operation, follow the [add-operation](../add-operation/SKILL.md) skill |
...
| `handle_modal_input()` | Keys within a modal overlay | See [add-modal](../add-modal/SKILL.md) skill |
...
In [src/ui/help.rs](../../../src/ui/help.rs), add the keybinding to the appropriate section.
...
- [ ] If async: sentinel + dispatch added per [add-operation](../add-operation/SKILL.md)
